...
var TimerId;  // variable to store ID for setInterval timer function
var hr = 00;  // variable to store current hour time
var min = 00;  // variable to store current minute time
var sec = 00;  // variable to store current second time
var stopWatchRunning = false;   // variable to know whether the stopwatch currently running or not
